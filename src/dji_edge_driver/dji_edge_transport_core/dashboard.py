    ...
    def __init__(self, host: str, port: int, state_provider: Callable[[], dict[str, Any]], stop_callback: Callable[[], None], config_provider: Callable[[], dict[str, Any]] | None = None, config_saver: Callable[[dict[str, Any], bool], dict[str, Any]] | None = None) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_POST(self) -> None:
                if self.path == "/v1/config" and parent._config_saver is not None:
                    try:
