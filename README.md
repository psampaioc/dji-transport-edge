...
- Raw Android records: `/dji/telemetry/flight`, `/dji/telemetry/rtk`, `/dji/telemetry/gimbal`, `/dji/telemetry/battery`, `/dji/telemetry/health`, `/dji/telemetry/frame_metadata`, and `/dji/telemetry/video_access_unit` (`std_msgs/String` containing compact JSON).
